...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  if(isset($data -> operation)){
   ...
   if(!empty($operation)){
      ...
      else if ($operation == 'insertPost'){

        if(isset($data -> post) && !empty($data -> post) && isset($data -> post -> email)
            && isset($data -> post -> title) && isset($data -> post -> newspost)){
            ...
            echo $fun -> insertPost($email, $title, $isi);
        } else {
            echo $fun -> getMsgInvalidEmail();
        }

      }
      else if ($operation == 'listPost'){
